...
def correct_passportKey():
    spell_checker_file_path = u"C:/Users/logoskdy/AppData/Local/anaconda3/Lib/site-packages/hanspell/spell_checker.py"

    passport_key = get_passport_key()
    if passport_key:
        fix_spell_checker_py_code(spell_checker_file_path, passport_key)
        print('passportKey를 추가했습니다.')
    else:
